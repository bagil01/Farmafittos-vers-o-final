    ...
    <?php if ($resultado->num_rows > 0): ?>
      <?php while ($noticia = $resultado->fetch_assoc()): ?>
        <div class="opcao">
          ...
          <div class="incons">
            <!-- Botão restaurar -->
            <form method="POST" action="../../backend/crud_noticia/restaurar_noticia.php" style="display:inline;">
            ...
            <form method="POST" action="../../backend/crud_noticia/excluir_definitivo.php" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja excluir permanentemente?');">
              <input type="hidden" name="id_noticia" value="<?= $noticia['id'] ?>">
